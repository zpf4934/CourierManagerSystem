...
import com.agen.library.util.DateUtil;
	...
	public class People_ji  extends JFrame implements ActionListener {
				...
				if (e.getSource() == btnSearch) {
					...
					if (name != null && !name.equals("")){
					    sql = "select sendphone,sendname,"
					    		+ "senddanwei,sendadress from send where sendname like " + "'" +name + "'" ;
					}
					else if(starttime != null && !starttime.equals("") && 
							endtime!= null && !endtime.equals("")){
						sql = "select sendphone,sendname,"
					    		+ "senddanwei,sendadress from send where riqi BETWEEN " + "'" +starttime +"'" + " AND " + "'" +  endtime+ "'" ;
					}
				
					StuModel_ji sm = new StuModel_ji(sql);
					tabel.setModel(sm);
				}
